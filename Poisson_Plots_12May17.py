...
if EdgePlot:
    ...
    nycenter2 = nycenter - 16 * GridsPerPixelY * ScaleFactor
...
print "Channel Stops BG"
for i in range(dat.elec.shape[2]):
    print "k = %d, z=%.3f, phi = %.3f, holes = %.3f, elec = %.3f, rho = %.3f, Ez = %.3f"%(i,dat.z[i],dat.phi[nxcenter+ScaleFactor*GridsPerPixelX/2, nycenter+ScaleFactor*GridsPerPixelY/2,i],dat.hole[nxcenter+ScaleFactor*GridsPerPixelX/2, nycenter+ScaleFactor*GridsPerPixelY/2,i],dat.elec[nxcenter+ScaleFactor*GridsPerPixelX/2, nycenter+ScaleFactor*GridsPerPixelY/2,i],dat.rho[nxcenter+ScaleFactor*GridsPerPixelX/2, nycenter+ScaleFactor*GridsPerPixelY/2,i],dat.Ez[nxcenter+ScaleFactor*GridsPerPixelX/2, nycenter+ScaleFactor*GridsPerPixelY/2,i])

print "Channel Stops CG"
for i in range(dat.elec.shape[2]):
    print "k = %d, z=%.3f, phi = %.3f, holes = %.3f, elec = %.3f, rho = %.3f, Ez = %.3f"%(i,dat.z[i],dat.phi[nxcenter+ScaleFactor*GridsPerPixelX/2, nycenter,i],dat.hole[nxcenter+ScaleFactor*GridsPerPixelX/2, nycenter,i],dat.elec[nxcenter+ScaleFactor*GridsPerPixelX/2, nycenter,i],dat.rho[nxcenter+ScaleFactor*GridsPerPixelX/2, nycenter,i],dat.Ez[nxcenter+ScaleFactor*GridsPerPixelX/2, nycenter,i])
...
#print dat.Ez[nxcenter+ScaleFactor*GridsPerPixelX/2, nycenter+ScaleFactor*GridsPerPixelY/2,0:64]
#print dat.hole[nxcenter+ScaleFactor*GridsPerPixelX/2, nycenter+ScaleFactor*GridsPerPixelY/2,:]
