...
class Array3D //This packages the 3D data sets
{
 public:
  int nx, ny, nz;
  double xmin, xmax, ymin, ymax, zmin, zmax, dx, dy, dzp, nzexp, *x, *y, *z, *zp, *zpz, *zmz, *zw, *zplus, *zminus, *dzpdz, *TR, *data;
  double sensorthickness;
  int ChannelCkmin, ChannelStopCkmin, ChannelVkmin, ChannelStopVkmin, *Ckmin, *Vkmin;
  Array3D() {};
