...
subplot(1,2,1,aspect=1)
title("Phi(x,z) y = %.2f"%dat.y[nycenter2])
xlabel("X-Dimension (microns)")
...
ylabel("Z-Dimension (microns)")
nzmin = 0
nzmax = 120 * ScaleFactor
#nxmin2 = 280 # Top and Bottom
#nxmax2 = 400
nxmin2 = 80 # Left and Right
nxmax2 = 120 
[zz,xx] = meshgrid(dat.z[nzmin:nzmax],dat.x[nxmin2:nxmax2])
contour(xx,zz,dat.phi[nxmin2:nxmax2,nycenter2,nzmin:nzmax],levels,lw=0.1)
contourf(xx,zz,dat.phi[nxmin2:nxmax2,nycenter2,nzmin:nzmax],levels)
cb=colorbar(orientation='horizontal')
cb.set_ticks([-60.0,-45.0,-30.0,-15.0,0.0,15.0])
cb.set_label('$\phi(x,z)$ [V]')
[zz,xx] = meshgrid(dat.z[nzmin:nzmax],dat.x[nxmin2:nxmax2])
