...
fluxes = []
for kk in range(6):
    fluxes.append(ChargeDepth(dat,None,centers[kk][0], centers[kk][1], dn/2, dn/2, dat.Elec.shape[2], recomb_factor=recomb_factor))
bheights = []
linefluxes = []
linebheights = []
...
plot(fluxes, array(bheights)*1000.0, marker = '*', label = "Vph = %.1f"%Vph)
plot([0,300000],[1100.0, 1100.0], color = 'blue', ls = '--')
text(200000, 1100.0,"Limit")
